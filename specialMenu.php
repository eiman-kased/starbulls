...
<body>
    <div class="header">
        <div class="logo">
            <a href="index.php">
                <img src="imgs/starbullslogo.png" alt="logo" /></a>
        </div>
        <h1>STARBULLS
            <div class="topnav">
    ...
    <article>
        <div id="Specials">
            ...
            <dt>Milk Chocolate Mondays</dt>
            <dd>Come and enjoy hot milk chocolate for a party of 4 for only the price of 3.
                ...
                for new friends or family.... ($50/per table of 4)
            </dd>
            <hr>
            <dt>Tingle Tuesdays</dt>
            <dd>Have you had a long day of web development? Well come to StarBulls on Tuesdays
                ...
                in an extra bone in there. ($20/combo)</dd>
            <hr>
            <dt>Wings n Wednesdays</dt>
            <dd>Tis' the middle of an hardworking week, come to StarBulls and let us get you a great discount
                ...
                experience here
                in Buffalo. We will not dissapoint. ($100/per table of 4)</dd>
            <hr>
            <dt>Tasty Thursdays </dt>
            <dd>On Thursdays, we completely shut down our kitchen and open up our giant drinks bar. There will be
                discounted
                ...
                ($8.25)</dd>
            <hr>
            <dt>Flying Fridays</dt>
            <dd>If you come to StarBulls on a Friday, prepare to be taken on a ride. We completely transform the
                restaurant
                ...
                For $5 more
                add on a generous amount of ranch to create snow on the plane. ($80.00)</dd>
            <hr>
            <dt>Seasoned Saturdays</dt>
            <dd>Stop by on Seasoned Saturdays to try our special homemade dry rub wings seasoning. The seasoning is
                a secret
                ...
                well.
                ($20.95/per 12pc combo)
                <div id="resp"><b>*Drink responsibly* </b></div>
            </dd>
            <hr>
            <dt>*CLOSED*</dt>
            <dd>Sorry for the inconvenience.</dd>
            <hr>
    </article>
    </div>
